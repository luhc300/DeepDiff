...
from src.configs.network_configs.mnist.network_config_5 import NETWORK_STRUCTURE, NETWORK_ANCHOR, NETWORK_PATH, INIT, LEARNING_RATE, DISTRIBUTION_PATH
...
X_train, y_train, X_test, y_test = data_prepare(4)
...
def train():
    ...
    cnn_profiler.train(input_dim, output_dim, x, y, iter=3000)
def test():
